...
func Header(isHome bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<header class=\"relative z-10 font-serif\"><nav class=\"mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8\" aria-label=\"Global\"><div class=\"flex lg:flex-1\"><a href=\"/\" class=\"-m-1.5 p-1.5\"><span class=\"sr-only\">LifeofMarrow</span> <img class=\"h-24 w-auto\" src=\"/static/img/logo.png\" alt=\"logo\"></a></div><div class=\"flex lg:hidden\"><button type=\"button\" class=\"-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700\" _=\"on click remove .hidden from #mobile-menu transition #mobile-menu&#39;s opacity to 1 over 200ms\"><span class=\"sr-only\">Open main menu</span> <svg class=\"h-6 w-6\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" aria-hidden=\"true\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5\"></path></svg></button></div>")
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\">Get in touch <span aria-hidden=\"true\">&rarr;</span></a></div></nav><!-- Mobile menu, show/hide based on menu open state. --><div id=\"mobile-menu\" class=\"hidden opacity-0 lg:hidden\" role=\"dialog\" aria-modal=\"true\"><!-- Background backdrop, show/hide based on slide-over state. --><div class=\"fixed inset-0 z-10\" _=\"on click transition #mobile-menu&#39;s opacity to 0 over 150ms then add .hidden to #mobile-menu\"></div><div class=\"fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10\"><div class=\"flex items-center justify-between\"><a href=\"/\" class=\"-m-1.5 p-1.5\"><span class=\"sr-only\">LifeofMarrow</span> <img class=\"h-24 w-auto\" src=\"/static/img/logo-responsive.png\" alt=\"side menu logo\"></a> <button type=\"button\" class=\"-m-2.5 rounded-md p-2.5 text-gray-700\" _=\"on click transition #mobile-menu&#39;s opacity to 0 over 150ms then add .hidden to #mobile-menu\"><span class=\"sr-only\">Close menu</span> <svg class=\"h-6 w-6\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" aria-hidden=\"true\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M6 18L18 6M6 6l12 12\"></path></svg></button></div><div class=\"mt-6 flow-root\"><div class=\"-my-6 divide-y divide-gray-500/10\"><div class=\"space-y-2 py-6\"><div class=\"-mx-3\"><a href=\"/about\" class=\"-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50\">About</a> <a href=\"/recipes\" class=\"-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50\">Recipes</a> <button type=\"button\" _=\"on click toggle .rotate-180 on &lt;svg/&gt; in me toggle .hidden on the next &lt;div/&gt;\" class=\"-mx-3 flex w-full items-center justify-between rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50\" aria-controls=\"disclosure-1\" aria-expanded=\"false\">Store & Services<!--\n                  Expand/collapse icon, toggle classes based on menu open state.\n\n                  Open: \"rotate-180\", Closed: \"\"\n                --><svg class=\"h-5 w-5 flex-none\" viewBox=\"0 0 20 20\" fill=\"currentColor\" aria-hidden=\"true\"><path fill-rule=\"evenodd\" d=\"M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z\" clip-rule=\"evenodd\"></path></svg></button><!-- 'Product' sub-menu, show/hide based on menu state. --><div class=\"mt-2 space-y-2\" id=\"disclosure-1\"><a href=\"#\" class=\"block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50\">Analytics</a></div></div></div><div class=\"py-6\"><a href=\"/contact\" class=\"-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50\">Get in touch</a></div></div></div></div></div></header>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
