...
func RecipeTile(r RecipeEntity, pageNo int, isLast bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(`on mouseover add .scale-90 to (.img in me) add .text-gray-900 to (<h3/> in me) remove .hidden from (.stats in me) end
				on mouseout remove .scale-90 from (.img in me) remove .text-gray-900 from (<h3/> in me) add .hidden to (.stats in me) end`)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 87, Col: 126}
		}
		...
		var templ_7745c5c3_Var3 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/recipe/%s", slug.Make(r.Title)))
		...
		if len(r.MealTypes.Data) > 0 {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Join(getMealTypeStrings(r.MealTypes), ", "))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 95, Col: 59}
			}
		...
		if len(r.Cuisine.Data.Attributes.Cuisine) > 0 {
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(r.Cuisine.Data.Attributes.Cuisine)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 101, Col: 42}
			}
		...
		if len(r.Duration.Data.Attributes.Time) > 0 {
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(r.Duration.Data.Attributes.Time)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 107, Col: 40}
			}
		...
		if len(r.Requirements.Data) > 0 {
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Join(getRequirementStrings(r.Requirements), ", "))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 113, Col: 65}
			}
		...
		if len(r.Images.Data) > 0 {
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(helpers.GetStrapiMediaUrl(r.Images.Data[0].Attributes.Url))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 119, Col: 70}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 131, Col: 14}
		}
		...
		if isLast {
			...
			templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("pager-%d", pageNo))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/recipe_tile.templ`, Line: 137, Col: 43}
			}
